...
CREATE TABLE `movies` (
  ...
  `review` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  ...
  `poster_public_id` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `banner_public_id` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `thumbnail_public_id` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2023-05-19  9:50:40
